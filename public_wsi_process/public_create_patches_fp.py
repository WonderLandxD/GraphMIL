# internal imports
from public_wsi_process.wsi_core.WholeSlideImage import WholeSlideImage
from public_wsi_process.wsi_core.wsi_utils import StitchCoords
from public_wsi_process.wsi_core.batch_process_utils import initialize_df
# other imports
import os
import numpy as np
import time
...
parser.add_argument('--source', type = str, default='D:/LocalPC_PythonProject/openslide_demo/img/tif/slides',
