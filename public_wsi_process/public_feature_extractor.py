...
def parse_args():
    ...
    parser.add_argument('--tiles_dir', type=str, default='D:/LocalPC_PythonProject/openslide_demo/img/tif/tiles')
    parser.add_argument('--feat_dir', type=str, default='D:/LocalPC_PythonProject/openslide_demo/img')
